...
const getGithubFile = function() {
  // request({
  //   url: 'https://api.github.com/repos/reallyloveme/default-template/contents/src/template'
  // },
  // function(err, response, body) {
  //   if(err) {
  //     log(`❌  获取github数据异常 ${err}`)
  //     return
  //   }
  //   log(`获取的数据 ${JSON.stringify(response)}`)
  //   log(`获取的数据2 ${JSON.stringify(body)}`)
  // })

  https.get(
    'https://api.github.com/repos/reallyloveme/default-template/contents/src/template',
  (res) => {
